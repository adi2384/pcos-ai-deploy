...
const NewsSymptoms = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/news/symptoms")
      .then((res) => setArticles(res.data.articles))
      .catch((err) => console.error("Error fetching symptoms articles:", err));
  }, []);

  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold mb-4 text-center text-pink-700">PCOS Symptoms Articles</h1>
